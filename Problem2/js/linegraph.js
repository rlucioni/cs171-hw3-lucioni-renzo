...
var boundingBox, canvasHeight, canvasWidth, color, generateLineGraph, headers, labelPadding, line, margin, svg, xAxis, xScale, yAxis, yScale,
...
generateLineGraph = function(dataset) {
  var all_estimates, all_years, data, estimate, frame, header, org, point, year, _i, _j, _len, _len1, _results;
  all_years = [];
  all_estimates = [];
  for (org in dataset) {
    data = dataset[org];
