...
var August2012, February2012, annotations, bbContext, bbFocus, canvasHeight, canvasWidth, contextLine, contextXAxis, contextXScale, contextYAxis, contextYScale, focusArea, focusLine, focusXAxis, focusXScale, focusYAxis, focusYScale, generateGraph, margin, padding, parseDate, svg;
...
generateGraph = function(dataset) {
  ...
  focusFrameMask.selectAll("text").data(remarkableEvents).enter().append("text").attr("class", "annotation focus").attr("transform", function(d) {
    return "translate(" + (focusXScale(d.date) + padding.annotationOffset) + ", " + (focusYScale(d.tweets) + padding.annotationOffset) + ")";
  }).text(function(d) {
    var _l, _len3;
